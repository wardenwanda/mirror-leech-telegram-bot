...
class _BotCommands:
    def __init__(self):
        ...
        self.CancelMirror = f'c{CMD_INDEX}'
        self.CancelAllCommand = f'ca{CMD_INDEX}'
        ...
        self.RestartCommand = f'reboot{CMD_INDEX}'
        ...
        self.QbUnzipMirrorCommand = f'qzm{CMD_INDEX}'
        ...
        self.ZipLeechCommand = f'zl{CMD_INDEX}'
        self.QbLeechCommand = f'ql{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'qbunzipleech{CMD_INDEX}'
        self.QbZipLeechCommand = f'qzl{CMD_INDEX}'
        self.LeechWatchCommand = f'lw{CMD_INDEX}'
        self.LeechZipWatchCommand = f'lzw{CMD_INDEX}'
